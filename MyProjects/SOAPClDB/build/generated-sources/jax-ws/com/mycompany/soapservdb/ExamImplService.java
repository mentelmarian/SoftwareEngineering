 ...
 * 
 */
@WebServiceClient(name = "ExamImplService", targetNamespace = "http://soapservdb.mycompany.com/", wsdlLocation = "http://localhost:8080/MovieDatabase?WSDL")
    ...
    extends Service
{
    ...
    private final static QName EXAMIMPLSERVICE_QNAME = new QName("http://soapservdb.mycompany.com/", "ExamImplService");
    ...
    public Exam getExamImplPort() {
        return super.getPort(new QName("http://soapservdb.mycompany.com/", "ExamImplPort"), Exam.class);
    }
    ...
    public Exam getExamImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapservdb.mycompany.com/", "ExamImplPort"), Exam.class, features);
    }
