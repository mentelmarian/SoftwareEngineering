 ...
 * generated in the com.mycompany.soapservdb package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetStudent_QNAME = new QName("http://soapservdb.mycompany.com/", "getStudent");
    private final static QName _GetStudentResponse_QNAME = new QName("http://soapservdb.mycompany.com/", "getStudentResponse");
    private final static QName _Student_QNAME = new QName("http://soapservdb.mycompany.com/", "student");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.soapservdb
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapservdb.mycompany.com/", name = "getStudent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapservdb.mycompany.com/", name = "getStudentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapservdb.mycompany.com/", name = "student")
