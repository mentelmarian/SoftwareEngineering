 ...
 * 
 */
@WebServiceClient(name = "ExamImplService", targetNamespace = "http://soapservluglio.mycompany.com/", wsdlLocation = "http://localhost:8070/Exam?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXAMIMPLSERVICE_QNAME = new QName("http://soapservluglio.mycompany.com/", "ExamImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8070/Exam?wsdl");
    ...
    public Exam getExamImplPort() {
        return super.getPort(new QName("http://soapservluglio.mycompany.com/", "ExamImplPort"), Exam.class);
    }
    ...
    public Exam getExamImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapservluglio.mycompany.com/", "ExamImplPort"), Exam.class, features);
    }
