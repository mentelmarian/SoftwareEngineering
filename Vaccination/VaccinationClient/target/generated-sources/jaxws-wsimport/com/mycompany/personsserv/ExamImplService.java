 ...
 * 
 */
@WebServiceClient(name = "ExamImplService", targetNamespace = "http://personsserv.mycompany.com/", wsdlLocation = "http://localhost:8070/Exam?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXAMIMPLSERVICE_QNAME = new QName("http://personsserv.mycompany.com/", "ExamImplService");
    ...
    public Exam getExamImplPort() {
        return super.getPort(new QName("http://personsserv.mycompany.com/", "ExamImplPort"), Exam.class);
    }
    ...
    public Exam getExamImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://personsserv.mycompany.com/", "ExamImplPort"), Exam.class, features);
    }
